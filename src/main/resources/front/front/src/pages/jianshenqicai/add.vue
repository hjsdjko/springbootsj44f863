...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}' label="器材编号" prop="qicaibianhao">
              <el-input v-model="ruleForm.qicaibianhao" placeholder="器材编号" disabled></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}' label="器材名称" prop="qicaimingcheng">
            <el-input v-model="ruleForm.qicaimingcheng" 
                placeholder="器材名称" clearable :disabled=" false  ||ro.qicaimingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}'  label="器材类型" prop="qicaileixing">
            <el-select v-model="ruleForm.qicaileixing" placeholder="请选择器材类型" :disabled=" false  ||ro.qicaileixing" >
              <el-option
          ...
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}' label="品牌" prop="pinpai">
            <el-input v-model="ruleForm.pinpai" 
                placeholder="品牌" clearable :disabled=" false  ||ro.pinpai"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}' label="使用方法" prop="shiyongfangfa">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="使用方法"
          ...
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}' label="瘦身效果" prop="shoushenxiaoguo">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="瘦身效果"
          ...
          <el-form-item :style='{"width":"49%","padding":"10px","margin":"0 0 10px","background":"none"}' label="器材介绍" prop="qicaijieshao">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/qicaileixing/qicaileixing', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`jianshenqicai/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('jianshenqicai/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`jianshenqicai/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
