	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="适合人群" prop="shiherenqun">
					<el-input v-model="ruleForm.shiherenqun" placeholder="适合人群" clearable  :readonly="ro.shiherenqun"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="适合人群" prop="shiherenqun">
					<el-input v-model="ruleForm.shiherenqun" placeholder="适合人群" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="课程简介" prop="kechengjianjie">
					<editor 
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengjianjie" label="课程简介" prop="kechengjianjie">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.kechengjianjie = this.ruleForm.kechengjianjie.replace(reg,'../../../springbootsj44f863/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
