<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程编号" prop="kechengbianhao">
					<el-input v-model="ruleForm.kechengbianhao" placeholder="课程编号" clearable  :readonly="ro.kechengbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="课程编号" prop="kechengbianhao">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课时" prop="keshi">
					<el-input v-model="ruleForm.keshi" placeholder="课时" clearable  :readonly="ro.keshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="课时" prop="keshi">
					<el-input v-model="ruleForm.keshi" placeholder="课时" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程费用" prop="kechengfeiyong">
					<el-input-number v-model="ruleForm.kechengfeiyong" placeholder="课程费用" :readonly="ro.kechengfeiyong"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="课程费用" prop="kechengfeiyong">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="购买时间" prop="goumaishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.goumaishijian" label="购买时间" prop="goumaishijian">
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `kechengdingdan/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.kechengdingdanCrossAddOrUpdateFlag = false;
											this.parent.search();
