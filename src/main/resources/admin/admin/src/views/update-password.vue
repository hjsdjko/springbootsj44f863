<template>
  <div :style='{"padding":"30px"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="原密码" prop="password">
        <el-input v-model="ruleForm.password" show-password></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="新密码" prop="newpassword">
        <el-input v-model="ruleForm.newpassword" show-password></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="确认密码" prop="repassword">
		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'jianshenjiaolian') {
					}
					this.user.password = this.ruleForm.newpassword;
					this.user.mima = this.ruleForm.newpassword;
					this.$http({
