<template>
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="用户名" prop="yonghuming">
          <el-input v-model="ruleForm.yonghuming" readonly              placeholder="用户名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='yonghu'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="手机号" prop="shoujihao">
          <el-input v-model="ruleForm.shoujihao"               placeholder="手机号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='yonghu'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jianshenjiaolian'"  label="教练工号" prop="jiaoliangonghao">
          <el-input v-model="ruleForm.jiaoliangonghao" readonly              placeholder="教练工号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jianshenjiaolian'"  label="教练姓名" prop="jiaolianxingming">
          <el-input v-model="ruleForm.jiaolianxingming"               placeholder="教练姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='jianshenjiaolian'"  label="健身课程" prop="jianshenkecheng">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='jianshenjiaolian'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jianshenjiaolian'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jianshenjiaolian'"  label="身高" prop="shengao">
          <el-input v-model="ruleForm.shengao"               placeholder="身高" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jianshenjiaolian'"  label="体重" prop="tizhong">
          <el-input v-model="ruleForm.tizhong"               placeholder="体重" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='jianshenjiaolian'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
		...
		<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='jianshenjiaolian'" label="职业履历" prop="zhiyelvli">
		  <editor
		  	style="min-width: 200px; max-width: 600px;"
			 :style='{"border":"1px solid #000","minHeight":"250px","width":"100%","height":"auto"}'
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'jianshenjiaolian' ==this.flag && this.ruleForm.discussnum&&(!isIntNumer(this.ruleForm.discussnum))){
       this.$message.error(`评论数应输入整数`);
        return
      }


      if( 'jianshenjiaolian' ==this.flag && this.ruleForm.storeupnum&&(!isIntNumer(this.ruleForm.storeupnum))){
